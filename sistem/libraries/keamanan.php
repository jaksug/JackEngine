...
class XP_Keamanan{
    public $xss_hash			= '';
	public $csrf_hash			= '';
    public $csrf_token_name		= 'xp_csrf_token';
	public $csrf_cookie_name	= 'xp_csrf_token';
    public $str_tidak_boleh = array(
    ...
    public $regex_tidak_boleh = array(
    ...
    public function xss_clean($str, $is_image = FALSE){
		...
		foreach ($this->str_tidak_boleh as $key => $val)
		{
			$str = str_replace($key, $val, $str);
		}

		foreach ($this->regex_tidak_boleh as $key => $val)
		{
	...
	{
		return $this->entity_decode($match[0], strtoupper(konfig_item('charset')));
	}
