                ...
                <div class="row-fluid">
                    ...
                    <div class="span5 " >
                        <div class=" span12 input-append  "id="pencarian">
                            <input autocomplete="off" id="xp-pencarian" class="span8" placeholder="temukan sesuatu..." id="appendedInputButtons" size="16" type="text"><button class="btn btn-inverse" type="button"> <i class="icon icon-white icon-search"></i> Telusuri</button>
                        </div>
                        <ul class="nav span12">
